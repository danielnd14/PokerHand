...
class StraightFlushStrategy implements PokerClassifier {
	private Map<CardValue, List<Card>> groupValue
	private Map<Suit, List<Card>> groupNaipe
	List<Card> cardList

	StraightFlushStrategy(List<Card> listCards, Map<CardValue, List<Card>> groupValue, Map<Suit, List<Card>> groupNaipe) {
